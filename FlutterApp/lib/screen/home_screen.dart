...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _fetchQuizzes() async {
    ...
    final response = await http.get("api 주소");
        ...
        child: Scaffold(
            ...
            body: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  padding: EdgeInsets.all(width * .036),
                ),
                        ...
                        onPressed: (){
                              ...
                              SnackBar(
                                  content: Row(
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        padding: EdgeInsets.only(left: width * .036),
                                      ),
                                      Text("로딩 중")
                                    ],
                              ))
                          ...
                          _fetchQuizzes().whenComplete(() {
                            return Navigator.push(
                                ...
                                builder: (context) => QuizScreen(quizzes: quizzes,))
                            );
                          });
                        },
                      ),
      ...
      child: Row(
        ...
        children: <Widget>[
          Icon(
            ...
            size:  width * .04,),
          Padding(
            padding: EdgeInsets.only(right: width * .024),
          ),
          Text(title)
        ],
      ),
